      ...
      return (
        <section id = "mainContent">
            <div className = "mainContent">
                ...
                <p>
                In this project, as a team of six, we designed, evaluated, and fabricated a device to enable a dairy farmer with prosthetic leg and spina bifida to access the controls of his milk tank with more ease than the status quo. A hydraulic lift with the capacity to support the client was selected for modifications; though the lift was not purchased, various modifications to the lift were fabricated over the course of the project and can be installed on the selected lift when purchased by the client. A railing and gate to ensure the lift’s safety was fabricated using square steel tubing, MIG welding, and low carbon hot rolled flat. Additionally, a steel-and-wood platform was created to mimic the lift’s platform to accommodate the rails. This design should solve the problem of not only our client, but other farmers with similar cases. Out final design document can be viewed here. As a leader, I made sure to guide the team to the completion of the project.
                </p>
                <ul>
                  <li>
